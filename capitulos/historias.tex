\subsection*{\textit{Plugin WorkAssignment}}

Nesta subseção serão apresentadas um primeiro levantamento das histórias correspondentes a evolução do plugin Work Assignment. Até então, o plugin possui apenas a funcionalidade de permitir o envio de arquivos para o servidor em um determinado período de tempo.
...
Como avanço evoluir o \textit{plugin} de tal forma que seja oferecido ao professor definir o tempo em que a atividade estará disponível para o envio, uma vez que atualmente é realizada de maneira manual, não possibilitando definir intervalos de tempo. A seguir estão descritas as histórias correspondentes a essa evolução.
